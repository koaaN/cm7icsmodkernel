...
{
	int res = BBM_NOK;
	unsigned int f_rf = DEFAULT_CH_FREQ; // 37ch
...
int fc8100_set_freq(HANDLE hDevice, u8 ch_num)
{
	...
	//latin_cam:namkh-2010.06.17, comment out for improving channel searching speed
	//PRINTF(0, "Channel Nummber : %d\n", ch_num);

	f_rf = (ch_num- 13) * 6000  + 473143;
	f_if = TUN_IF_FREQ; //tun_if_freq;
