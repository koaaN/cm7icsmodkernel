...
#    fi
    ...
    CROSS_PREFIX="/Everything/Android/Cyanogenmod/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-"
}
...
build ()
{
    ...
    cp "$target_dir"/arch/arm/boot/zImage arch/arm/boot/zImage1
